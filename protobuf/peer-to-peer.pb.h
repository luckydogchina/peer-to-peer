...
// required int32 counter = 2;
inline bool ConnectRequest::has_counter() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ConnectRequest::set_has_counter() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ConnectRequest::clear_has_counter() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ConnectRequest::clear_counter() {
  counter_ = 0;
  clear_has_counter();
}
inline ::google::protobuf::int32 ConnectRequest::counter() const {
  // @@protoc_insertion_point(field_get:p2p.ConnectRequest.counter)
  return counter_;
}
inline void ConnectRequest::set_counter(::google::protobuf::int32 value) {
  set_has_counter();
  counter_ = value;
...
template <> struct is_proto_enum< ::p2p::MessageType> : ::google::protobuf::internal::true_type {};
template <>
